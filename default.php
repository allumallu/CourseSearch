...
<html>
    <head>
        <title>Tervetuloa <? print $host; ?>!</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.fi/"><img src="http://www.main-hosting.com/hostinger/welcome/images/logo.png" alt="Web hosting" /></a>
                </div>
                <div class="content">
                    <h1>Käyttäjäsi on luotu onnistuneesti!</h1>
                    <p>Verkkosivu <b><? print $host; ?></b> on onnistuneesti asennettu palvelimelle! Ole hyvä ja poista <b>default.php</b> -tiedosto <b>public_html</b> - kansiosta ja lataa verkkosivusi sitten FTP:llä tai Tiedostonhallinnalla.</p>
                    <p>Tässä on lista tiedostoistasi public_html-kansiossa:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.fi/webhotelli" target="_blank">Webhotelli</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.fi/ilmainen-webhotelli" target="_blank">Ilmainen webhotelli</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.fi/forum" target="_blank">Tukifoorumi</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.fi/" target="_blank">Kirjaudu</a>
                </div>
                <div class="copyright">Hostinger &copy; <? print date('Y'); ?>. Kaikki oikeudet pidätetään.</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.fi"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
